...
using Corno.Logger;
using Corno.Education.Areas.Services;
...
public class StudentExamController : ExamController
{
    ...
    {
        LogHandler.LogInfo("In StudentExamController (Create)");
        try
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                LogHandler.LogInfo($"StudentExamController (Create) : Submitting Exam form. Instance : {viewModel.InstanceId}, College : {viewModel.CollegeId}, PRN : {viewModel.PrnNo}, Total Fee : {viewModel.Total}");
                if (viewModel.CollegeId == 45 && viewModel.Total <= 0)
                {
                    ...
                    LogHandler.LogInfo($"StudentExamController (Create) :  Instance : {viewModel.InstanceId}, PRN : {viewModel.PrnNo}, Transaction Id : null");
