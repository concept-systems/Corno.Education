using Corno.Logger;
using Corno.Education.Areas.Transactions.Dtos;
...
using Corno.Reports.Additional_Credits;
...
public class AdditionalCreditsController : BaseController
{
    ...
    public ActionResult ShowReport()
    {
        try
        {
            ...
            var report = new AdditionalCreditsRpt(coreService);
            
            Session[ModelConstants.Report] = report;
            return RedirectToAction("Details", "Report", new { area = "Reports", reportName = ReportName.AdditionalCreditsRpt, description = "Additional Credits Report" });
        }
        catch (Exception exception)
        {
            HandleControllerException(exception);
