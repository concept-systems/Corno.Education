!function() {
    ...
    var d3_event_dragSelect = "onselectstart" in d3_document
            ? null
                        ...
                        .tween("zoom:zoom",
                            function() {
                                var dx = size[0],
                                    ...
                                    cy = dy / 2,
                                    i = d3
                                        .interpolateZoom([(cx - view.x) / view.k, (cy - view.y) / view.k, dx / view.k],
    ...
    d3.hsl = function(h, s, l) {
        return arguments.length === 1
            ? h instanceof d3_Hsl ? d3_hsl(h.h, h.s, h.l) : d3_rgb_parse("" + h, d3_rgb_hsl, d3_hsl)
            : d3_hsl(+h, +s, +l);
    };
    ...
    d3.lab = function(l, a, b) {
        return arguments.length === 1
            ? l instanceof d3_Lab
            ? d3_lab(l.l, l.a, l.b)
            : l instanceof d3_Hcl ? d3_hcl_lab(l.l, l.c, l.h) : d3_rgb_lab((l = d3.rgb(l)).r, l.g, l.b)
            : d3_lab(+l, +a, +b);
    };
    ...
    d3.rgb = function(r, g, b) {
        return arguments.length === 1
            ? r instanceof d3_Rgb ? d3_rgb(r.r, r.g, r.b) : d3_rgb_parse("" + r, d3_rgb, d3_hsl_rgb)
            : d3_rgb(~~r, ~~g, ~~b);
    };
    ...
    function d3_geo_clipCircle(radius) {
        ...
        function intersect(a, b, two) {
            ...
            if (meridian
                ? polar ? φ0 + φ1 > 0 ^ q[1] < (abs(q[0] - λ0) < ε ? φ0 : φ1) : φ0 <= q[1] && q[1] <= φ1
                : δλ > π ^ (λ0 <= q[0] && q[0] <= λ1)) {
    ...
    d3.geo.albersUsa = function() {
        ...
        albersUsa.invert = function(coordinates) {
            ...
            return (y >= .12 && y < .234 && x >= -.425 && x < -.214
                ? alaska
                : y >= .166 && y < .234 && x >= -.214 && x < -.115 ? hawaii : lower48).invert(coordinates);
        };
    ...
    function d3_geo_rotation(δλ, δφ, δγ) {
        return δλ
            ? δφ || δγ ? d3_geo_compose(d3_geo_rotationλ(δλ), d3_geo_rotationφγ(δφ, δγ)) : d3_geo_rotationλ(δλ)
    ...
    function d3_geom_voronoiHalfEdge(edge, lSite, rSite) {
        ...
        this.angle = rSite
            ...
            : edge.l === lSite ? Math.atan2(vb.x - va.x, va.y - vb.y) : Math.atan2(va.x - vb.x, vb.y - va.y);
    }
    ...
    d3.interpolators = [
        function(a, b) {
            var t = typeof b;
            return (t === "string"
                    ? d3_rgb_names.has(b) || /^(#|rgb\(|hsl\()/.test(b) ? d3_interpolateRgb : d3_interpolateString
                    : b instanceof d3_Color
                    ? d3_interpolateRgb
                    : t === "object"
                    ? Array.isArray(b) ? d3_interpolateArray : d3_interpolateObject
    ...
    function d3_ease_bounce(t) {
        return t < 1 / 2.75
            ...
            : t < 2.5 / 2.75 ? 7.5625 * (t -= 2.25 / 2.75) * t + .9375 : 7.5625 * (t -= 2.625 / 2.75) * t + .984375;
    }
            ...
            if (children && children.length) {
                var rect = pad(node),
                    ...
                    u = mode === "slice"
                        ...
                        : mode === "dice"
                        ? rect.dy
                        : mode === "slice-dice" ? node.depth & 1 ? rect.dy : rect.dx : Math.min(rect.dx, rect.dy),
                    n;
    ...
    function d3_scale_quantile(domain, range) {
        ...
        scale.invertExtent = function(y) {
            ...
            return y < 0
                ? [NaN, NaN]
                : [
                    y > 0 ? thresholds[y - 1] : domain[0], y < thresholds.length
                    ? thresholds[y]
    ...
    var d3_time_scaleLocalMethods = [
        ...
        [d3_time.month, 1],
        [d3_time.month, 3], [d3_time.year, 1]
    ];
