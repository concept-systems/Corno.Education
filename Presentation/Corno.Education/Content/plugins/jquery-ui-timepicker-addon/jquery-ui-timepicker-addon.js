...
// add timepicker as a property of datepicker: $.datepicker._get(dp_inst, 'timepicker');
            ...
            var timezoneList = [
                ...
                0, 60, 120, 180, 210, 240, 270, 300, 330, 345, 360, 390, 420, 480, 525, 540, 570, 600, 630, 660, 690,
                720, 765, 780, 840
            ];
        ...
        _injectTimePicker: function() {
            ...
            if ($dp.find("div.ui-timepicker-div").length === 0 && o.showTimepicker) {
                var noDisplay = ' style="display:none;"',
                    html = '<div class="ui-timepicker-div' +
                ...
                for (i = 0, l = this.units.length; i < l; i++) {
                    ...
                    max[litem] = parseInt((o[litem + "Max"] -
            ...
            */
            ...
            if (!this._defaults.showTimepicker) {
                ...
                if (!this._defaults.timeOnly) {
                    if (this._defaults.altFormat) {
                        altFormattedDateTime = $.datepicker
                            .formatDate(this._defaults.altFormat, (dt === null ? new Date() : dt), formatCfg);
                    } else {
                ...
                if (this._defaults.altTimeFormat) {
                    altFormattedDateTime += $.datepicker
                        .formatTime(this._defaults.altTimeFormat, this, this._defaults) +
                        altTimeSuffix;
                } else {
        ...
        _controls: {
            ...
            select: {
                ...
                options: function(tp_inst, obj, unit, opts, val) {
                    ...
                    return tp_inst.control.create(tp_inst,
                        obj,
                        $t.data("unit"),
                        $t.val(),
                        o.min || $t.data("min"),
    ...
    */
    ...
    $.datepicker.formatTime = function(format, time, options) {
        ...
        tmptime = tmptime.replace(/(?:HH?|hh?|mm?|ss?|[tT]{1,2}|[zZ]|[lc]|'.*?')/g,
            function(match) {
                switch (match) {
                case "HH":
                ...
                case "z":
                    return $.timepicker
                        .timezoneOffsetString(time.timezone === null ? options.timezone : time.timezone, false);
                case "Z":
                    return $.timepicker
                        .timezoneOffsetString(time.timezone === null ? options.timezone : time.timezone, true);
                case "T":
    ...
    $.datepicker._updateAlternate = function(inst) {
        ...
        if (tp_inst) {
            ...
            if (altField) { // update alternate field too
                ...
                altFormattedDateTime += $.datepicker.formatTime(altTimeFormat, tp_inst, tp_inst._defaults) +
                    altTimeSuffix;
                if (!tp_inst._defaults.timeOnly && !tp_inst._defaults.altFieldTimeOnly && date !== null) {
                    if (tp_inst._defaults.altFormat) {
                        altFormattedDateTime = $.datepicker.formatDate(tp_inst._defaults.altFormat, date, formatCfg) +
                            altSeparator +
                            altFormattedDateTime;
                    } else {
