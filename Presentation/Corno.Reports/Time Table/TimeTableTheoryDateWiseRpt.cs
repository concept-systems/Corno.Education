...
public partial class TimeTableTheoryDateWiseRpt : Report
{
    #region -- Connstructors --
    public TimeTableTheoryDateWiseRpt(ICornoService transactionService)
    {
    ...
    #region -- Events --
    private void TimeTableTheoryDateWiseRpt_NeedDataSource(object sender, EventArgs e)
    {
            ...
            dataSource.AddRange(timeTable.TimeTableTheoryDetails
                .Where(t => theoryCategories.Contains(t.CategoryCode ?? 0) && t.StartDate != null).Select(t =>
                    new
                    {
                        ...
                        CoursePartName = ExamServerHelper.GetCoursePartShortName(timeTable.CoursePartId, examService),
                        timeTable.BranchId,
