...
{
    partial class SubjectSummaryRpt
    {
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(SubjectSummaryRpt));
            ...
            this.textBox10.Value = "= Fields.M + IIF(Fields.MTheory <= 0, \"\", \"\r\n\" + Fields.MTheory) + IIF(Fields.MPr" +
    "actical <= 0, \"\", \"\r\n\" + Fields.MPractical) + IIF(Fields.MIa  <= 0, \"\", \"\r\n\" + F" +
    "ields.MIa )";
            // 
            // textBox12
            // 
            ...
            this.textBox15.Value = "= Fields.F + IIF(Fields.FTheory <= 0, \"\", \"\r\n\" + Fields.FTheory) + IIF(Fields.FPr" +
    "actical <= 0, \"\", \"\r\n\" + Fields.FPractical) + IIF(Fields.FIa  <= 0, \"\", \"\r\n\" + F" +
    "ields.FIa )";
            // 
            // textBox3
            // 
    ...
    "     FROM Tbl_COURSE_PART_MSTR\r\nWhere Num_FK_CO_CD = @CourseID";
            ...
            this.NeedDataSource += new System.EventHandler(this.SubjectSummaryRpt_NeedDataSource);
