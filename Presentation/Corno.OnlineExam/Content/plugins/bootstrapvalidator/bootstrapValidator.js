    ...
    BootstrapValidator.prototype = {
                    ...
                    function(e) {
                        ...
                        if (that.options.fields) {
                            ...
                            if (!that.isValid()) {
                                ...
                                if (!that.submitHandlerCalled &&
                                    that.options.submitHandler &&
                                    "function" == typeof that.options.submitHandler) {
                    ...
                    (function(field) {
                        ...
                        if ($field) {
                            var type = $field.attr("type"),
                                event = ("checkbox" == type || "radio" == type || "SELECT" == $field.get(0).tagName)
                                    ? "change"
                                    : "keyup";
                            $field.on(event,
                                function() {
        ...
        validateField: function(field) {
            ...
            for (var validatorName in validators) {
                ...
                var isValid = $.fn.bootstrapValidator.validators[validatorName]
                    .validate(that, $field, validators[validatorName]);
                if (isValid === false) {
