...
public class Tbl_STUDENT_PAP_MARKSMap : EntityTypeConfiguration<Tbl_STUDENT_PAP_MARKS>
{
    public Tbl_STUDENT_PAP_MARKSMap()
    {
        // Primary Key
        HasKey(t => new { t.Var_FK_PRN_NO, t.Num_FK_SUB_CD, t.Num_FK_CAT_CD, t.Num_FK_PAP_CD, t.Num_FK_INST_NO, t.Dtm_ST_PH_DTE_CR });
